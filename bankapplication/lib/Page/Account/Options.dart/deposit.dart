    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          SizedBox(height: 400, child: FormDeposit()),
        ],
      ),
    );
  }
...
class FormDeposit extends ConsumerWidget {
                  ...
                  child: Container(
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () async {
                        ...
                        http.Response responseDeposit = await SendDeposit(
                            accountNumber, amountController.text);

                        print(responseDeposit.statusCode);
                        if (responseDeposit.statusCode == 200) {
                          endBalance = UpdateBalance.fromJson(
                              jsonDecode(responseDeposit.body));
